...
public class AllOrdersFragment extends BaseFragment implements IView{  //全部订单
    ...
    private void requestData() {
        mIPrecenter.startRequestData(String.format(Apis.URL_AllOrders,0),null, AllOrderBean.class,2,mUserId,mSessionId);
    }

    @Override
    public int getContent() {
        return R.layout.indentfragment_allorders;
    }
    ...
    public void showData(Object data) {
        ...
        if (data instanceof AllOrderBean){
            ...
            final AllOrderAdapter allOrderAdapter = new AllOrderAdapter(getActivity(), orderList);
