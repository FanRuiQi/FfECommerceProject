...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.ViewHolder>{  //展示待评论Adapter

    private Context mContext;
    private List<AllOrderBean.OrderListBean> list;

    public CommentAdapter(Context context, List<AllOrderBean.OrderListBean> list) {
        mContext = context;
        this.list = list;
    }
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        final CommentChildAdapter childAdapter = new CommentChildAdapter(mContext,detailList,orderId);
